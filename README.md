...
| 영역 | 내용 |
|---|---|
| 스토리 Top 10 (기본 화면) | 같은 사건을 다룬 기사 묶음 단위 순위. 한 사건이 여러 국면으로 갈라져 순위를 뒤덮지 않도록 **이슈 단위로 접어** 한 줄만 차지한다('국면 18' 표시, 상세에서 다른 국면을 눌러 볼 수 있음). 대표 헤드라인 + 공통 키워드, 기사 수, 많이 본 기사에 올린 언론사 수, 검색 출처. 누르면 한 문장 설명·흐름 곡선(24·48·72시간)·묶인 기사(많이 본 기사 먼저). 키워드 칩을 누르면 그 말이 든 기사만 남김 |
