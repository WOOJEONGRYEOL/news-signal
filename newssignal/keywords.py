...
MULTI_SUFFIX = [
    ...
    "어놓고", "해놓고", "놓고", "두고", "받고", "내고", "잡고", "보고", "타고", "지고", "치고", "먹고", "가고", "오고", "않고", "없이",
    "었더니", "았더니", "였더니", "더니", "못해", "못한", "못할", "못했", "못하", "겠다", "겠나", "겠지", "네요", "어요", "아요", "세요",
    "네요", "군요", "구나", "네", "죠", "요",
]
...
되는 하는 많이 적게 크게 작게 높게 낮게 빨리 늦게 따로 서로 스스로 더욱 매우 이게 그게 저게 이건 그건 저건 이젠 그냥 어차피 결국엔 무려 겨우 오직 단지
싸우 싸운 싸워 싸우는 실패 성공 시작 마무리 준비 완료 계속 중단 재개 연기 취소 확정 결정 선정 지정 발생 발견 등장 출현 사라진 사라져 나타난 나타나
우린 하나 둘 셋 데가 할인 저희 그들 이들 우리가 우리는 나는 내가 너는 네가 당신 자기 남 놈 년 님 분 애 얘 걔 쟤
